...
import { applyLeafletDrawFrenchLabels } from "@/lib/leaflet-draw-locale-fr";
...
export function CountryGeometryOsmEditor({
  ...
  useEffect(() => {
    ...
    applyLeafletDrawFrenchLabels(L);
    ...
    L.tileLayer("https://{s}.tile.openstreetmap.fr/osmfr/{z}/{x}/{y}.png", {
      ...
      subdomains: "abc",
      attribution:
        '&copy; <a href="https://www.openstreetmap.org/copyright">OpenStreetMap</a> · <a href="https://openstreetmap.fr/">OSM France</a>',
    }).addTo(map);
